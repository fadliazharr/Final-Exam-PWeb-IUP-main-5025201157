...
<title>Profil | Bondo Space Studio</title>
...
<body id="page-top">
	<!-- Navigation-->
	<header>
        <h2><a href=" #">Bondo Space Studio</a></h2>
        <nav>
	...
	<!-- Footer-->
	<footer>
        <p>All Right reserved by &copy; <a href="#">Pemograman Web IUP 2023</a></p>
    </footer>
